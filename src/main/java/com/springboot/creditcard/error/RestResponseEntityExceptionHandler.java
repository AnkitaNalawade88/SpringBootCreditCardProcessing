...
import com.springboot.creditcard.entity.ErrorMessage;
...
public class RestResponseEntityExceptionHandler
    ...
    public ResponseEntity<ErrorMessage> cardAlreadyExistException(CardAlreadyExistException exception,
                                                              WebRequest request) {
    ...
    public ResponseEntity<ErrorMessage> cardNotFoundException(CardNotFoundException exception,
                                                                    WebRequest request) {
